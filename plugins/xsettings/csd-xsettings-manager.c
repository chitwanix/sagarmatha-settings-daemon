...
#define SOUND_SETTINGS_SCHEMA     "org.sagarmatha.desktop.sound"

#define XSETTINGS_PLUGIN_SCHEMA "org.sagarmatha.settings-daemon.plugins.xsettings"
...
typedef void (* TranslationFunc) (SagarmathaSettingsXSettingsManager *manager,
...
struct SagarmathaSettingsXSettingsManagerPrivate
{
        guint              start_idle_id;
...
static void     sagarmatha_xsettings_manager_class_init  (SagarmathaSettingsXSettingsManagerClass *klass);
static void     sagarmatha_xsettings_manager_init        (SagarmathaSettingsXSettingsManager      *xsettings_manager);
static void     sagarmatha_xsettings_manager_finalize    (GObject                  *object);

G_DEFINE_TYPE (SagarmathaSettingsXSettingsManager, sagarmatha_xsettings_manager, G_TYPE_OBJECT)
...
static void
translate_bool_int (SagarmathaSettingsXSettingsManager *manager,
                    TranslationEntry      *trans,
                    GVariant              *value)
{
        int i;
...
static void
translate_int_int (SagarmathaSettingsXSettingsManager *manager,
                   TranslationEntry      *trans,
                   GVariant              *value)
{
        int i;
...
static void
translate_string_string (SagarmathaSettingsXSettingsManager *manager,
                         TranslationEntry      *trans,
                         GVariant              *value)
{
        int i;
...
static void
translate_string_string_toolbar (SagarmathaSettingsXSettingsManager *manager,
                                 TranslationEntry      *trans,
                                 GVariant              *value)
{
        int         i;
...
static TranslationEntry translations [] = {
        { "org.sagarmatha.settings-daemon.peripherals.mouse", "double-click",   "Net/DoubleClickTime",  translate_int_int },
        { "org.sagarmatha.settings-daemon.peripherals.mouse", "drag-threshold", "Net/DndDragThreshold", translate_int_int },

        { "org.sagarmatha.desktop.interface", "gtk-color-palette",      "Gtk/ColorPalette",        translate_string_string },
        { "org.sagarmatha.desktop.interface", "font-name",              "Gtk/FontName",            translate_string_string },
        { "org.sagarmatha.desktop.interface", "gtk-key-theme",          "Gtk/KeyThemeName",        translate_string_string },
        { "org.sagarmatha.desktop.interface", "toolbar-style",          "Gtk/ToolbarStyle",        translate_string_string_toolbar },
        { "org.sagarmatha.desktop.interface", "toolbar-icons-size",     "Gtk/ToolbarIconSize",     translate_string_string },
        { "org.sagarmatha.desktop.interface", "can-change-accels",      "Gtk/CanChangeAccels",     translate_bool_int },
        { "org.sagarmatha.desktop.interface", "cursor-blink",           "Net/CursorBlink",         translate_bool_int },
        { "org.sagarmatha.desktop.interface", "cursor-blink-time",      "Net/CursorBlinkTime",     translate_int_int },
        { "org.sagarmatha.desktop.interface", "cursor-blink-timeout",   "Gtk/CursorBlinkTimeout",  translate_int_int },
        { "org.sagarmatha.desktop.interface", "gtk-theme",              "Net/ThemeName",           translate_string_string },
        { "org.sagarmatha.desktop.interface", "gtk-timeout-initial",    "Gtk/TimeoutInitial",      translate_int_int },
        { "org.sagarmatha.desktop.interface", "gtk-timeout-repeat",     "Gtk/TimeoutRepeat",       translate_int_int },
        { "org.sagarmatha.desktop.interface", "gtk-color-scheme",       "Gtk/ColorScheme",         translate_string_string },
        { "org.sagarmatha.desktop.interface", "gtk-im-preedit-style",   "Gtk/IMPreeditStyle",      translate_string_string },
        { "org.sagarmatha.desktop.interface", "gtk-im-status-style",    "Gtk/IMStatusStyle",       translate_string_string },
        { "org.sagarmatha.desktop.interface", "gtk-im-module",          "Gtk/IMModule",            translate_string_string },
        { "org.sagarmatha.desktop.interface", "icon-theme",             "Net/IconThemeName",       translate_string_string },
        { "org.sagarmatha.settings-daemon.plugins.xsettings", "menus-have-icons", "Gtk/MenuImages",          translate_bool_int },
        { "org.sagarmatha.settings-daemon.plugins.xsettings", "buttons-have-icons",     "Gtk/ButtonImages",        translate_bool_int },
        { "org.sagarmatha.desktop.interface", "menubar-accel",          "Gtk/MenuBarAccel",        translate_string_string },
        { "org.sagarmatha.desktop.interface", "enable-animations",      "Gtk/EnableAnimations",    translate_bool_int },
        { "org.sagarmatha.desktop.interface", "cursor-theme",           "Gtk/CursorThemeName",     translate_string_string },
        { "org.sagarmatha.desktop.interface", "cursor-size",            "Gtk/CursorThemeSize",     translate_int_int },
        { "org.sagarmatha.settings-daemon.plugins.xsettings", "show-input-method-menu", "Gtk/ShowInputMethodMenu", translate_bool_int },
        { "org.sagarmatha.settings-daemon.plugins.xsettings", "show-unicode-menu",      "Gtk/ShowUnicodeMenu",     translate_bool_int },
        { "org.sagarmatha.settings-daemon.plugins.xsettings", "automatic-mnemonics",    "Gtk/AutoMnemonics",       translate_bool_int },
        { "org.sagarmatha.desktop.sound", "theme-name",                 "Net/SoundThemeName",            translate_string_string },
        { "org.sagarmatha.desktop.sound", "event-sounds",               "Net/EnableEventSounds" ,        translate_bool_int },
        { "org.sagarmatha.desktop.sound", "input-feedback-sounds",      "Net/EnableInputFeedbackSounds", translate_bool_int }
};

static gboolean
notify_idle (gpointer data)
{
        SagarmathaSettingsXSettingsManager *manager = data;
        gint i;
        for (i = 0; manager->priv->managers [i]; i++) {
...
static void
queue_notify (SagarmathaSettingsXSettingsManager *manager)
{
...
static double
get_dpi_from_gsettings (SagarmathaSettingsXSettingsManager *manager)
{
...
} SagarmathaSettingsXftSettings;

/* Read GSettings and determine the appropriate Xft settings based on them. */
static void
xft_settings_get (SagarmathaSettingsXSettingsManager *manager,
                  SagarmathaSettingsXftSettings      *settings)
{
...
static void
xft_settings_set_xsettings (SagarmathaSettingsXSettingsManager *manager,
                            SagarmathaSettingsXftSettings      *settings)
{
        int i;
...
static void
xft_settings_set_xresources (SagarmathaSettingsXftSettings *settings)
{
        GString    *add_string;
 ...
 */
static void
update_xft_settings (SagarmathaSettingsXSettingsManager *manager)
{
        SagarmathaSettingsXftSettings settings;
...
static gboolean
start_fontconfig_monitor_idle_cb (SagarmathaSettingsXSettingsManager *manager)
{
        sagarmatha_settings_profile_start (NULL);
...
static void
start_fontconfig_monitor (SagarmathaSettingsXSettingsManager  *manager)
{
        sagarmatha_settings_profile_start (NULL);
...
static void
stop_fontconfig_monitor (SagarmathaSettingsXSettingsManager  *manager)
{
...
static void
process_value (SagarmathaSettingsXSettingsManager *manager,
               TranslationEntry      *trans,
               GVariant              *value)
{
...
static gboolean
setup_xsettings_managers (SagarmathaSettingsXSettingsManager *manager)
{
        GdkDisplay *display;
        int         i;
        int         n_screens;
...
gboolean
sagarmatha_xsettings_manager_start (SagarmathaSettingsXSettingsManager *manager,
                               GError               **error)
{
        GVariant    *overrides;
        guint        i;
...
void
sagarmatha_xsettings_manager_stop (SagarmathaSettingsXSettingsManager *manager)
{
        SagarmathaSettingsXSettingsManagerPrivate *p = manager->priv;
        int i;
...
static GObject *
sagarmatha_xsettings_manager_constructor (GType                  type,
...
static void
sagarmatha_xsettings_manager_class_init (SagarmathaSettingsXSettingsManagerClass *klass)
{
        GObjectClass *object_class = G_OBJECT_CLASS (klass);

        object_class->constructor = sagarmatha_xsettings_manager_constructor;
        object_class->finalize = sagarmatha_xsettings_manager_finalize;

        g_type_class_add_private (klass, sizeof (SagarmathaSettingsXSettingsManagerPrivate));
}
...
static void
sagarmatha_xsettings_manager_finalize (GObject *object)
{
        SagarmathaSettingsXSettingsManager *xsettings_manager;
        ...
        G_OBJECT_CLASS (sagarmatha_xsettings_manager_parent_class)->finalize (object);
}

SagarmathaSettingsXSettingsManager *
sagarmatha_xsettings_manager_new (void)
{
