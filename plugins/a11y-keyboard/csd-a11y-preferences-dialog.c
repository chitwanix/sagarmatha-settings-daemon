...
#define INTERFACE_SCHEMA          "org.sagarmatha.desktop.interface"
#define KEY_TEXT_SCALING_FACTOR   "text-scaling-factor"

#define KEYBOARD_A11Y_SCHEMA      "org.sagarmatha.desktop.a11y.keyboard"
...
#define KEY_AT_SCHEMA                "org.sagarmatha.desktop.a11y.applications"
...
config_set_high_contrast (gboolean enabled)
{
        ...
        settings = g_settings_new ("org.sagarmatha.desktop.interface");
        wm_settings = g_settings_new ("org.sagarmatha.desktop.wm.preferences");
