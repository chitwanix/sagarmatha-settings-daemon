...
static void
session_state_changed (SagarmathaSettingsSession *session, GParamSpec *pspec, gpointer user_data)
{
...
#define SCREENSAVER_NAME "org.sagarmatha.ScreenSaver"
#define SCREENSAVER_PATH "/org/sagarmatha/ScreenSaver"
#define SCREENSAVER_INTERFACE "org.sagarmatha.ScreenSaver"
                                       ...
                                       GError              **error)
{
        ...
        manager->priv->settings = g_settings_new ("org.sagarmatha.desktop.media-handling");
