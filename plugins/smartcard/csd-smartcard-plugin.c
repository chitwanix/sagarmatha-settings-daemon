...
#define SCREENSAVER_DBUS_NAME      "org.sagarmatha.ScreenSaver"
#define SCREENSAVER_DBUS_PATH      "/"
#define SCREENSAVER_DBUS_INTERFACE "org.sagarmatha.ScreenSaver"
...
get_configured_remove_action (CsdSmartcardPlugin *plugin)
{
        ...
        settings = g_settings_new ("org.sagarmatha.settings-daemon.peripherals.smartcard");
