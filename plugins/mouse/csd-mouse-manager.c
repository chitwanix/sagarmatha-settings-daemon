...
#define SETTINGS_MOUSE_DIR         "org.sagarmatha.settings-daemon.peripherals.mouse"
...
csd_mouse_manager_idle_cb (CsdMouseManager *manager)
{
        ...
        manager->priv->mouse_a11y_settings = g_settings_new ("org.sagarmatha.desktop.a11y.mouse");
