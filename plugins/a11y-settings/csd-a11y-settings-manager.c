                                 ...
                                 GError                **error)
{
	...
	manager->priv->interface_settings = g_settings_new ("org.sagarmatha.desktop.interface");
	manager->priv->a11y_apps_settings = g_settings_new ("org.sagarmatha.desktop.a11y.applications");
