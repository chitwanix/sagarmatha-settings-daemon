...
#define CINNAMON_TYPE_SETTINGS_MODULE               (sagarmatha_settings_module_get_type ())
#define CINNAMON_SETTINGS_MODULE(obj)               (G_TYPE_CHECK_INSTANCE_CAST ((obj), CINNAMON_TYPE_SETTINGS_MODULE, SagarmathaSettingsModule))
#define CINNAMON_SETTINGS_MODULE_CLASS(klass)       (G_TYPE_CHECK_CLASS_CAST ((klass), CINNAMON_TYPE_SETTINGS_MODULE, SagarmathaSettingsModuleClass))
...
#define CINNAMON_SETTINGS_MODULE_GET_CLASS(obj)     (G_TYPE_INSTANCE_GET_CLASS((obj), CINNAMON_TYPE_SETTINGS_MODULE, SagarmathaSettingsModuleClass))
